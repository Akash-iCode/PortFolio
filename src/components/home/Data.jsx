...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Akash Bhingare 
            <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle"> <b> Visual Designer </b></h3>
        <p className="home__description"> I'm a creative designer based in Pune and very passionate and an enthusiastic developer.</p>
        <a href="#contact" className="glowing-button4">Say Hello
            <svg
                    class="button__icon"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
